    ...
    <Container>
      ...
      <div className=" py-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <span>
            <p onClick={() => setAddress('headquarters')} className="font-semibold font-inter text-xl mb-2 cursor-pointer hover:text-indian-yellow">Nigeria Headquarters</p>
          ...
          <span>
            <p onClick={() => setAddress('uk')} className="font-semibold font-inter text-xl mb-2 cursor-pointer hover:text-indian-yellow">United Kingdom Office</p>
            <p className="p leading-7 mb-8">
