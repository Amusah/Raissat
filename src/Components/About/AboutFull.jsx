  ...
  return (
    <section className="main">
      <div className="py-16">
        ...
        <div className="flex flex-col sm:flex-row gap-5 text-midnight-green mt-5">
          {/* card */}
          <span className="w-max">
            <ul className="p leading-5 list-disc text-xs rounded-xl border-3 border-light-green p-7">
              <li>
